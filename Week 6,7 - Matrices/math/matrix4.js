...
Matrix4.prototype = {
	...
	multiply: function(rightSideMatrix) {
		...
		var m15 = te[4] * oe[0]+ te[5] * oe[4] + te[6] * oe[8] + te[7] * oe[12];
		var m16 = te[4] * oe[1]+ te[5] * oe[5] + te[6] * oe[9] + te[7] * oe[13];
		var m17 = te[4] * oe[2]+ te[5] * oe[6] + te[6] * oe[10] + te[7] * oe[14];
		var m18 = te[4] * oe[3]+ te[5] * oe[7] + te[6] * oe[11] + te[7] * oe[15];
		var m19 = te[8] * oe[0]+ te[9] * oe[4] + te[10] * oe[8] + te[11] * oe[12];
		var m20 = te[8] * oe[1]+ te[9] * oe[5] + te[10] * oe[9] + te[11] * oe[13];
		var m21 = te[8] * oe[2]+ te[9] * oe[6] + te[10] * oe[10] + te[11] * oe[14];
		var m22 = te[8] * oe[3]+ te[9] * oe[7] + te[10] * oe[11] + te[11] * oe[15];
		var m23 = te[12] * oe[0]+ te[13] * oe[4] + te[14] * oe[8] + te[15] * oe[12];
		var m24 = te[12] * oe[1]+ te[13] * oe[5] + te[14] * oe[9] + te[15] * oe[13];
		var m25 = te[12] * oe[2]+ te[13] * oe[6] + te[14] * oe[10] + te[15] * oe[14];
		var m26 = te[12] * oe[3]+ te[13] * oe[7] + te[14] * oe[11] + te[15] * oe[15];
		this.set(m11,m12,m13,m14,m15,m16,m17,m18,m19,m20,m21,m22,m23,m24,m25,m26); {
